...
public class _6Question {
    public static void main(String[] args) {
        ...
        while(true) {
            System.out.print("Enter the indian cricket's name you want to search for:" );

            String name = scanner.nextLine();

           for(int i = 0; i < indianCricketers.length; i++) {
               if(name.equalsIgnoreCase(indianCricketers[i])) {
                   System.out.println(name.toUpperCase() + " found at index: " + i);
                   break;
               } else {
                   System.out.println(name.toUpperCase() + " not found in the list. Would you like to search for another name? (1 to continue)");
